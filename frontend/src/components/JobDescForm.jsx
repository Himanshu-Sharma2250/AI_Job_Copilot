...
import { useGenerate } from '../queries/AI_services';
...
const JobDescForm = () => {
    ...
    const {setResult, archetypes} = states();
    const navigate = useNavigate();
    console.log("arcje om does ", archetypes)
    ...
    const handleClick = async () => {
        ...
        formData.append("archetypes_json", JSON.stringify(archetypes));

        console.log("the data for generate : ", formData)
    ...
    return (
        <div className="bg-white border-4 border-black p-8 shadow-brutal flex flex-col gap-8 w-full transition-all">
            <div className="flex flex-col gap-3">
                <label className="text-3xl text-black uppercase tracking-tight">
                    1. Upload Resume (PDF)
                </label>
                <div className="relative border-4 border-black bg-[#f4f4f0] p-6 hover:bg-neo-lime transition-colors cursor-pointer group">
                    ...
                    <div className="flex justify-between items-center z-0 relative">
                        <span className="font-bold text-xl uppercase text-black">
            ...
            <div className="flex flex-col gap-3">
                ...
                <textarea 
                    ...
                    className='border-4 border-black p-6 h-64 text-black focus:outline-none focus:bg-neo-lime transition-colors font-medium text-xl resize-none shadow-inner'
                />
            </div>
